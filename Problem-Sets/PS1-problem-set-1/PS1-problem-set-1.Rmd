...
Inline code looks like this: `sum(1:10)` or `print("hello meow")`.
...
* an image file (`sample.png`)  
* a non-image file (`notes.txt`)  
* another folder (`empty_folder`)  

Just a simple test folder to practice with.
...
*(If it’s saved as `sketch.png` in my homework folder, it’ll show up here):*  
...
The screenshot above should show up when knitted. ✅
...
```
![](../../Desktop/info201_test_folder/sample.png)
```
...
The absolute path to my homework folder (where my `.Rmd` is) is:  
`C:/Users/josep/OneDrive/Documents/INFO_201/Problem-Sets/PS1-problem-set-1`

---

### **3.2**
#### **3.2.1  Absolute path of the image in test folder**
For the image I placed in the Desktop test folder, its absolute path looks like:  
`C:/Users/josep/Desktop/info201_test_folder/sample.png`
...
I’d prefer **relative paths** for homework. That way, if I move my project folder or send it to someone else, the images will still load correctly. Absolute paths only work on *my* computer.

---

### **3.5**
#### **3.5.1  RStudio filename completion**
In RStudio, you can start typing a filename inside quotes, then hit `Tab`. RStudio will autocomplete and suggest the files in your working directory — really helpful so you don’t mistype long file names.
...
I’ll assume a “typical” lifetime of about 80 years.  
...
There are 7 assignments (problem sets) worth 49% of the grade, so if I crush them all perfectly, that’s **49 points total**.
...
The proposal itself is worth 4% of the final project grade. The exact date is on Canvas under Assignments, but it’s due **early in the project timeline** (before the full final project).
...
Each student has **3 late days** for problem sets. After that, late submissions lose 0.5% per hour. (Ouch.)
...
### **5.10**
#### **5.10.1  Discord**
Not required, but yep — I joined the INFO 201 Discord: [https://discord.gg/KxGT2nXT9J](https://discord.gg/KxGT2nXT9J) 🎉
