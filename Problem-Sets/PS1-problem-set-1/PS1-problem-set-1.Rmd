...
```{r}
my_age <- 18
paste("My age now is", my_age, "years old")
```
...
paste("There are", seconds_in_year, "seconds in a year")
```
...
paste("My age in seconds is", age_in_seconds, "seconds")
```
...
paste("So a typical human lifetime is", lifetime_seconds, "seconds")
```
...
The Final Project Proposal due date is on **November 7 at 11:59 pm** 
...
### **5.10**
#### **5.10.1  Discord**
Not required, but yep, I have joined the INFO 201 Discord: [https://discord.gg/KxGT2nXT9J](https://discord.gg/KxGT2nXT9J)
