...
### **2.4 Filter to keep only 2020, and only deaths. Hint: you can use functions year(), month() and day() to extract years/months from dates**

```{r}
covid_compare <- read.delim("covid-scandinavia-nogrowth.csv", sep = "\t") %>%
...
### **3.2 Now compute average growth each month–calculate the monthly averages of the growth numbers you just computed. (Separately by country!) **
